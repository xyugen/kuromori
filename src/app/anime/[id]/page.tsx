          ...
          <div className='flex flex-col justify-center gap-3'>
            ...
            <div className='flex gap-2 flex-wrap'>
              <Button variant={'default'} className='w-full sm:w-fit' asChild>
                <Link href={`/anime/${params.id}/episode/1`}>Start Watching</Link>
              </Button>
          ...
          <TabsContent value='episodes'>
            ...
            <div className='flex flex-wrap gap-7 '>
              {animeInfo.episodes?.map((episode, index) => (
                <Link href={`/anime/${params.id}/episode/${index + 1}`} key={index} className='max-w-full w-full md:max-w-[160px] p-2 hover:bg-primary/40 rounded-sm'>
                  <Image
                    src={episode.image!}
                    alt={episode.title!}
                    width={400}
